...
WorldLoaded = function()
	...
	ObjectiveKillReactors = Greece.AddObjective("摧毁三座原子反应堆。")
	ObjectiveKillSAMSites = Greece.AddObjective("摧毁沿岸的苏联防空导弹阵地。")
	ObjectiveKillSilos = Greece.AddObjective("在发射前摧毁原子弹发射井。")
	ObjectiveNeutralizeChronosphere = Greece.AddObjective("瘫痪时空传送仪。")
	ObjectiveKeepAlive = Greece.AddSecondaryObjective("保持所有队员存活。")
...
DoShoreSAMFlare = function()
	Trigger.AfterDelay(DateTime.Seconds(4), function()
		...
		Notification("侦测到信号弹。已定位沿岸防空导弹阵地。按 [" .. UtilsCA.Hotkey("ToLastEvent") .. "] to view location.")
